...
<style>
  * { box-sizing: border-box; }
  ...
  <div class="pdf-root">
    ...
    <div class="pdf-block pdf-footer-block" style="margin-top:18px">
      <div class="footer-block">
        This reading is generated by Sunya AI for personal reflection only. Not medical advice. <span class="footer-link">desmondolubunmi.com</span>.
      </div>
    </div>
  </div>
</body></html>`;
